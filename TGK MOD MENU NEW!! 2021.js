...
// @include      https://moomoo-io-privated.glitch.me/?server=90:0:0
// @grant        none
	...
	, INT = setInterval(() => {
		if(1 == switched) {
			...
			$("#adCard")
				...
				.style.backgroundImage = "url('https://drive.google.com/file/d/1twyHW1OMEJGztk91K6-IiX-vSsOa6SvB/preview')";
			async function t(e) {
